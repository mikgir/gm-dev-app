...
return [
    ...
    'title' => env('MOONSHINE_TITLE', 'GM-dev'),
    ...
    'footer' => [
        'copyright' => 'Made with ❤️ by <a href="https://cutcode.dev" class="font-semibold text-purple hover:text-pink" target="_blank">GM-dev</a>',
        'nav' => [
